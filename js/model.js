...
export const traitBonus=()=>({id:uid('bonus'),icon:'',text:'',stat:'',statColor:'green'});
...
function normalizeTraitBonus(b){b=b&&typeof b==='object'?b:{};b.id||=uid('bonus');b.icon||='';b.text??=b.label??b.name??'';b.stat??=b.value??='';b.statColor=['green','red'].includes(b.statColor)?b.statColor:'green';delete b.value;delete b.label;delete b.name;return b}
